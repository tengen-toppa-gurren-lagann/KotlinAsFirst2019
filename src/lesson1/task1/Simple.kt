 ...
 */
fun numberRevert(number: Int): Int = firstDigit(number) * 100 + secondDigit(number) * 10 + thirdDigit(number)

fun secondDigit(number: Int): Int = number % 100 / 10
fun firstDigit(number: Int): Int = number % 10